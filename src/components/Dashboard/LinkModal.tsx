    ...
    return (
        ...
        >
            <Box sx={style}>
                ...
                <Link
                    to="https://discord.com/api/oauth2/authorize?client_id=1104888598165196800&redirect_uri=https%3A%2F%2Frbot.ac%2Fdcauth&response_type=code&scope=guilds%20identify%20guilds.join">
